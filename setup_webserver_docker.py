...
if __name__=="__main__":
	...
	if len(sys.argv) >1:
		...
		if sys.argv[1]=='full':
			...
			os.system('wget http://ftp.ebi.ac.uk/ensemblgenomes/pub/viruses/fasta/sars_cov_2/dna/Sars_cov_2.ASM985889v3.dna.toplevel.fa.gz -P ~/ReferenceData/')
			os.system('wget http://ftp.ebi.ac.uk/ensemblgenomes/pub/viruses/gtf/sars_cov_2/Sars_cov_2.ASM985889v3.101.gtf.gz -P ~/ReferenceData/') 
			os.system('wget http://ftp.ebi.ac.uk/ensemblgenomes/pub/viruses/fasta/sars_cov_2/cdna/Sars_cov_2.ASM985889v3.cdna.all.fa.gz -P ~/ReferenceData/')
